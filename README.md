...
- 📋 **Pegar texto e imágenes**: `⌘V` pega texto donde esté el cursor, y si el portapapeles trae una imagen (una captura, algo copiado de una web…) se guarda como PNG en el directorio de adjuntos y se inserta como `![imagen](notely://attachments/…)`, visible en la vista previa y el widget. `⌘C`/`⌘X`/`⌘A` también funcionan en cualquier campo.
